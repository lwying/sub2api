...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		RequestAuditForceEnabled:                               settings.RequestAuditForceEnabled,
		RequestAuditForceMessages:                              settings.RequestAuditForceMessages,
		RequestAuditForceChatCompletions:                       settings.RequestAuditForceChatCompletions,
		RequestAuditForceResponses:                             settings.RequestAuditForceResponses,
