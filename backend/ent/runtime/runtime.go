...
func init() {
	...
	// groupDescThinkingDisabledStrict is the schema descriptor for thinking_disabled_strict field.
	groupDescThinkingDisabledStrict := groupFields[39].Descriptor()
	// group.DefaultThinkingDisabledStrict holds the default value on creation for the thinking_disabled_strict field.
	group.DefaultThinkingDisabledStrict = groupDescThinkingDisabledStrict.Default.(bool)
	...
	// requestauditDescHeaders is the schema descriptor for headers field.
	requestauditDescHeaders := requestauditFields[1].Descriptor()
	// requestaudit.DefaultHeaders holds the default value on creation for the headers field.
	requestaudit.DefaultHeaders = requestauditDescHeaders.Default.(map[string]interface{})
	// requestauditDescEvents is the schema descriptor for events field.
	requestauditDescEvents := requestauditFields[2].Descriptor()
	// requestaudit.DefaultEvents holds the default value on creation for the events field.
	requestaudit.DefaultEvents = requestauditDescEvents.Default.([]map[string]interface{})
	// requestauditDescAttempts is the schema descriptor for attempts field.
	requestauditDescAttempts := requestauditFields[3].Descriptor()
	// requestaudit.DefaultAttempts holds the default value on creation for the attempts field.
	requestaudit.DefaultAttempts = requestauditDescAttempts.Default.([]map[string]interface{})
	// requestauditDescCaptureCompleteness is the schema descriptor for capture_completeness field.
	requestauditDescCaptureCompleteness := requestauditFields[4].Descriptor()
	// requestaudit.DefaultCaptureCompleteness holds the default value on creation for the capture_completeness field.
	requestaudit.DefaultCaptureCompleteness = requestauditDescCaptureCompleteness.Default.(string)
	// requestauditDescCaptureReason is the schema descriptor for capture_reason field.
	requestauditDescCaptureReason := requestauditFields[5].Descriptor()
	...
	_ = requestauditreservationFields
	// requestauditreservationDescLogicalKey is the schema descriptor for logical_key field.
	requestauditreservationDescLogicalKey := requestauditreservationFields[0].Descriptor()
	// requestauditreservation.LogicalKeyValidator is a validator for the "logical_key" field. It is called by the builders before save.
	requestauditreservation.LogicalKeyValidator = requestauditreservationDescLogicalKey.Validators[0].(func(string) error)
	// requestauditreservationDescRouteFamily is the schema descriptor for route_family field.
	requestauditreservationDescRouteFamily := requestauditreservationFields[1].Descriptor()
	// requestauditreservation.RouteFamilyValidator is a validator for the "route_family" field. It is called by the builders before save.
	requestauditreservation.RouteFamilyValidator = requestauditreservationDescRouteFamily.Validators[0].(func(string) error)
	// requestauditreservationDescForced is the schema descriptor for forced field.
	requestauditreservationDescForced := requestauditreservationFields[2].Descriptor()
	// requestauditreservation.DefaultForced holds the default value on creation for the forced field.
	requestauditreservation.DefaultForced = requestauditreservationDescForced.Default.(bool)
	// requestauditreservationDescHeaders is the schema descriptor for headers field.
	requestauditreservationDescHeaders := requestauditreservationFields[3].Descriptor()
	// requestauditreservation.DefaultHeaders holds the default value on creation for the headers field.
	requestauditreservation.DefaultHeaders = requestauditreservationDescHeaders.Default.(map[string]interface{})
	// requestauditreservationDescAttempts is the schema descriptor for attempts field.
	requestauditreservationDescAttempts := requestauditreservationFields[4].Descriptor()
	// requestauditreservation.DefaultAttempts holds the default value on creation for the attempts field.
	requestauditreservation.DefaultAttempts = requestauditreservationDescAttempts.Default.([]map[string]interface{})
	// requestauditreservationDescCaptureCompleteness is the schema descriptor for capture_completeness field.
	requestauditreservationDescCaptureCompleteness := requestauditreservationFields[6].Descriptor()
	// requestauditreservation.DefaultCaptureCompleteness holds the default value on creation for the capture_completeness field.
	requestauditreservation.DefaultCaptureCompleteness = requestauditreservationDescCaptureCompleteness.Default.(string)
	// requestauditreservationDescCaptureReason is the schema descriptor for capture_reason field.
	requestauditreservationDescCaptureReason := requestauditreservationFields[7].Descriptor()
	// requestauditreservation.DefaultCaptureReason holds the default value on creation for the capture_reason field.
	requestauditreservation.DefaultCaptureReason = requestauditreservationDescCaptureReason.Default.(string)
	// requestauditreservationDescCreatedAt is the schema descriptor for created_at field.
	requestauditreservationDescCreatedAt := requestauditreservationFields[10].Descriptor()
	// requestauditreservation.DefaultCreatedAt holds the default value on creation for the created_at field.
	requestauditreservation.DefaultCreatedAt = requestauditreservationDescCreatedAt.Default.(func() time.Time)
	// requestauditreservationDescUpdatedAt is the schema descriptor for updated_at field.
	requestauditreservationDescUpdatedAt := requestauditreservationFields[11].Descriptor()
	// requestauditreservation.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	requestauditreservation.DefaultUpdatedAt = requestauditreservationDescUpdatedAt.Default.(func() time.Time)
	// requestauditreservation.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	requestauditreservation.UpdateDefaultUpdatedAt = requestauditreservationDescUpdatedAt.UpdateDefault.(func() time.Time)
