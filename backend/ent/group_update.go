...
func (_u *GroupUpdate) SetThinkingDisabledStrict(v bool) *GroupUpdate {
	_u.mutation.SetThinkingDisabledStrict(v)
	return _u
}

// SetNillableThinkingDisabledStrict sets the "thinking_disabled_strict" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableThinkingDisabledStrict(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetThinkingDisabledStrict(*v)
	}
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ThinkingDisabledStrict(); ok {
...
// SetThinkingDisabledStrict sets the "thinking_disabled_strict" field.
func (_u *GroupUpdateOne) SetThinkingDisabledStrict(v bool) *GroupUpdateOne {
	_u.mutation.SetThinkingDisabledStrict(v)
	return _u
}

// SetNillableThinkingDisabledStrict sets the "thinking_disabled_strict" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableThinkingDisabledStrict(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetThinkingDisabledStrict(*v)
	}
	return _u
