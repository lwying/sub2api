<template>
  <AppLayout>
    <div class="space-y-6">
      ...
      <div class="card">
        ...
        <div v-show="activeTab === 'usage'" class="overflow-hidden rounded-b-2xl">
          <UsageTable
            ...
            @openRequestAudit="openRequestAudit"
          />
      ...
      <UsageRequestAuditDrawer v-model:show="showRequestAudit" :usage-log-id="selectedUsageLogId" />
    </div>
  </AppLayout>
...
import UsageRequestAuditDrawer from '@/components/admin/usage/UsageRequestAuditDrawer.vue'
...
const showRequestAudit = ref(false)
const selectedUsageLogId = ref<number | null>(null)
...
const openRequestAudit = (id: number) => { selectedUsageLogId.value = id; showRequestAudit.value = true }
