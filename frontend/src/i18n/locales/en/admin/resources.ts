export default {
    ...
    usage: {
      ...
      requestAudit: {
        ...
        wireRequestHeaders: 'Wire request headers',
        upstreamResponseHeaders: 'Upstream response headers',
        upstreamStatus: 'Upstream status',
        requestPayloadBytes: 'Request payload bytes',
        responsePayloadBytes: 'Response payload bytes',
        tokenCounts: {
          title: 'Token counts',
          input: 'Input tokens',
          output: 'Output tokens',
        },
        responseReadComplete: 'Response read complete',
        protocolFields: {
          title: 'Protocol fields',
          stream: 'Stream',
          thinkingType: 'Thinking type',
          presentFields: 'Present fields',
          normalizedFields: 'Normalization',
          thinkingDisabled: 'Disabled',
          thinkingEnabled: 'Enabled',
          thinkingAdaptive: 'Adaptive',
          normalizedThinkingExtraFieldsRemoved: 'Thinking extra fields removed',
          fieldModel: 'Model',
        ...
        no: 'No',
        unknown: 'Unknown',
        captureCompleteness: 'Capture completeness',
        captureStatuses: {
          complete: 'Complete',
          truncated: 'Truncated',
          incomplete: 'Response incomplete',
          writeFailed: 'Audit write failed',
          notCaptured: 'Not captured',
          unknown: 'Unknown',
        },
        eventFingerprint: 'HMAC fingerprint',
        modelFingerprint: 'Model fingerprint',
        clientResponse: {
          title: 'Client response',
          status: 'Status returned to client',
          bytes: 'Bytes written to client',
          observedNote:
        ...
        truncation: {
          ...
          keptEvents: 'Kept events',
          keptBytes: 'Kept bytes',
          droppedEvents: 'Dropped events',
          droppedBytes: 'Dropped bytes',
          reason: 'Reason',
          reasonMaxEvents: 'Maximum event count reached',
          reasonMaxBytes: 'Maximum event size reached',
          reasonUnknown: 'Unknown truncation reason',
        },
        notCapturedReasons: {
          phase1Uncovered: 'Not captured: this entry is outside first-phase request-audit coverage.',
          unknown: 'Not captured: no coverage reason was provided.',
        },
        valueDetail: {
          title: 'Short-term value detail',
          absent: 'No short-term value detail was collected for this request.',
          unavailable:
          ...
          latencyMs: 'Attempt latency',
          proxyId: 'Proxy ID',
          requestHeaders: 'Request header values',
          responseHeaders: 'Response header values',
          unknown: 'No value was recorded',
          states: {
            notObserved: 'Not collected',
            stored: 'Values available',
            skipped: 'Not retained',
            expired: 'Values expired',
            purged: 'Values cleared',
          },
          reasons: {
            notObserved: 'No short-term value was observed for this request',
            retained: 'Short-term values retained',
            skippedOutOfScope: 'This request did not call an Anthropic upstream',
            skippedRetentionDisabled: 'Short-term value retention is disabled',
